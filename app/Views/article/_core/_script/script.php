  ...
  <script src="<?= base_url ('assets/vendor/disqus/disqusloader.min.js') ?>"></script> 
...
{left: "\\[", right: "\\]", display: true}
  ...
  <script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=5c157c2c1c98570011922b96&product=sticky-share-buttons' async='async'></script>